    ...
    leadership: {
      ...
      content: (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <h3 style={{ color: 'white', fontSize: '1.25rem', marginBottom: '1rem', textAlign: 'center' }}>Leadership Roles</h3>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <div style={{
      ...
      content: (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <div style={{
            ...
            <h3 style={{ color: 'white', fontSize: '1.25rem', marginBottom: '1rem' }}>IEEE Publications</h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        ...
        <div style={{ maxWidth: '80rem', margin: '0 auto', position: 'relative', zIndex: 2 }}>
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ color: 'rgba(255, 255, 255, 0.7)', fontWeight: 600, fontSize: '0.9rem' }}>Years Learning</div>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{
                fontSize: '2rem',
              ...
              <div style={{ color: 'rgba(255, 255, 255, 0.7)', fontWeight: 600, fontSize: '0.9rem' }}>Projects Built</div>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{
                fontSize: '2rem',
              ...
              <div style={{ color: 'rgba(255, 255, 255, 0.7)', fontWeight: 600, fontSize: '0.9rem' }}>Technologies Explored</div>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{
                fontSize: '2rem',
              ...
              <div style={{ color: 'rgba(255, 255, 255, 0.7)', fontWeight: 600, fontSize: '0.9rem' }}>IEEE Publications</div>
            </div>
          </div>
        </div>
      </section>
